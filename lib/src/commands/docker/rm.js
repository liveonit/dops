...
var _1 = require("./");
var dockerRm = function (args) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        if (args.options.all) {
            _1.dokcerFunction(args, _1.Method.rmc);
            _1.dokcerFunction(args, _1.Method.rmn);
            _1.dokcerFunction(args, _1.Method.rmv);
            _1.dokcerFunction(args, _1.Method.rmi);
        }
        else {
