...
exports.program = new vorpal_1.default();
...
exports.storage = new utils_1.Storage(homedir + "/." + pkg.name);
exports.program.history("" + pkg.name);
var noargs = process.argv.slice(2).length === 0;
/**
 * ===========================================================================
...
if (noargs) {
    exports.program.delimiter("dops$").show().exec("help");
}
else {
    (function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, exports.program
                        .delimiter("")
                        .show()
